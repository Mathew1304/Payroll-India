              ...
              <div className="relative z-10">
                ...
                {!todayAttendance ? (
                  ...
                  >
                    ...
                    <span className="text-xs opacity-75">Start Day</span>
                  </button>
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      ...
                      <span className="text-xs opacity-75">End Day</span>
                    </button>
                  </div>
                ) : (
                  <div className="space-y-4">
                  ...
                  <tbody>
                    {allAttendanceRecords.map((record) => (
                      <tr key={record.id} className="border-b border-slate-100 hover:bg-slate-50 transition-colors">
                        ...
                        <td className="py-4 px-4">
                          <div className="flex items-center gap-2">
                            <span className={`px-3 py-1 rounded-full text-xs font-bold ${record.is_within_office_radius
