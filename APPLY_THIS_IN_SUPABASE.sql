...
-- ============================================================================
-- After running this, the schema cache will be reloaded automatically
-- ============================================================================

-- Step 1: Add the missing columns
DO $$
BEGIN
  -- Add accommodation_allowance
...
-- Step 2: Force PostgREST to reload the schema cache
NOTIFY pgrst, 'reload schema';

-- Step 3: Verify the critical columns were added
SELECT 
...
WHERE table_name = 'employees' 
  AND column_name IN ('accommodation_allowance', 'transportation_allowance', 'food_allowance')
